...
public class AuthenticationService {
    ...
    public void verifyUser(VerifyDto verifyDto) {
        Optional<User> optionalUser = userRepository.findUserByEmail(verifyDto.getEmail());
    ...
    public void sendVerificationEmail(User to){
        ...
        String htmlMessage =  "<html>"
                ...
                + "</html>";
        try {
            emailService.sendVerification(to.getEmail(), subject, htmlMessage);
    ...
    public void resendVerificationCode(String email){
        ...
        if (optionalUser.isPresent()){
            ...
            throw new RuntimeException("Account by this email not found");
        }
